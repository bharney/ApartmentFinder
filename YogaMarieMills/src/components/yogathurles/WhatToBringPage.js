        ...
        return (
            <div className="mdl-grid dark-color bg-color">
                <div className="ribbon bg-image-landing b-border">
                    <div className="container-fluid m-t-1-em m-b-1-em">
...
class WhatToBringPage extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="mdl-grid dark-color bg-color">
                <div className="ribbon bg-image-landing b-border">
                    <div className="container m-t-1-em m-b-1-em">
                        <h1 className="text-center color-white">What to Bring?</h1>
                        <div className="row p-b-15 m-b-1-em">

                            <div className="col-xs-offset-1 col-xs-10 p-b-15 m-b-1-em">
